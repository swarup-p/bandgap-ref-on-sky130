...
T {bangap reference circuit} 580 -220 0 0 0.6 0.6 {}
...
N 990 -420 990 -410 { lab=GND}
N 950 -450 950 -410 { lab=GND}
N 950 -410 990 -410 { lab=GND}
N 990 -450 1010 -450 { lab=GND}
...
N 670 -640 670 -600 { lab=#net4}
N 830 -640 830 -600 { lab=#net5}
...
N 440 -770 440 -730 { lab=#net6}
N 400 -730 440 -730 { lab=#net6}
N 400 -740 400 -600 { lab=#net6}
N 400 -670 430 -670 { lab=#net6}
...
C {gnd.sym} 1010 -450 0 0 {name=l32 lab=GND}
...
device=resistor
m=1}
C {xschem_sky130/sky130_fd_pr/pnp_05v5.sym} 970 -450 0 0 {name=Q10
model=pnp_05v5_W3p40L3p40
spiceprefix=X
}
...
device=resistor
m=1}
C {gnd.sym} 1110 -410 0 0 {name=l40 lab=GND}
C {gnd.sym} 990 -410 0 0 {name=l29 lab=GND}
